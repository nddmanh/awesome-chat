        ...
        socket.on("chat-image", (data) => {
            if (data.groupId) {
                ...
                if (clients[data.groupId]) {
                    emitNotifyToArray(clients, data.groupId, socket, "response-chat-image", response);
                }
            }
            if (data.contactId) {
                let response = {
                ...
                if (clients[data.contactId]) {
                    emitNotifyToArray(clients, data.contactId, socket, "response-chat-image", response);
                }
            }
        });
