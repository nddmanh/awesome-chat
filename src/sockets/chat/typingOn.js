        ...
        socket.on("user-is-typing", (data) => {
            if (data.groupId) {
                ...
                if (clients[data.groupId]) {
                    emitNotifyToArray(clients, data.groupId, socket, "response-user-is-typing", response);
                }
            }
            if (data.contactId) {
                let response = {
                ...
                if (clients[data.contactId]) {
                    emitNotifyToArray(clients, data.contactId, socket, "response-user-is-typing", response);
                }
            }
        });
