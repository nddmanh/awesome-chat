        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    ...
                    decreaseNumberNotiContact('count-request-contact-received'); // js/calculateNotifContact.js
                    increaseNumberNotiContact('count-contacts'); // js/calculateNotifContact.js
                    ...
                    // All stepd handle chat after approve contact
                    // Step 01: Hide modal
...
socket.on("response-approve-request-contact-received", function (user) {
    ...
    $(".noti_content").prepend(notif); // popup nitification
    $("ul.list-notifications").prepend(`<li> ${notif} </li>`); // Modal notificaiton
    ...
    decreaseNumberNotiContact('count-request-contact-sent'); // js/calculateNotifContact.js
    increaseNumberNotiContact('count-contacts'); // js/calculateNotifContact.js
